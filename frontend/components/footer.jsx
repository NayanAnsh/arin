...
const Footer = () => {
  return (
    ...
    <div className='footer  mt-auto    bottom-0 flex flex-row sm:grid sm:grid-flow-col  sm:justify-between  w-full  '>
        ...
        <img src="/assets/footer_logo.png" className=' mx-auto my-auto h-36 sm:h-32 p-3   ' alt="" />
        </div>
        <div className = 'flex sm:hidden mx-auto flex-col sm:flex-row ' >
          ...
          <div className=' flex   sm:flex-row  h-24 sm:h-32  space-x-2 sm:mr-4 sm:space-x-4 border-l-2 border-white border-opacity-50    my-auto'>
            ...
            <img src="/assets/facebookLogo.jpg" className=" ml-2 my-auto sm:ml-10 icons  rounded-full " alt="" />
            <img src="/assets/twitter.jpg" className=" my-auto icons rounded-full" alt="" />
            <img src="/assets/pintrestlogo.jpg" className=" my-auto hidden sm:block icons rounded-full " alt="" />
            <img src="/assets/instagram.jpg" className=" my-auto icons rounded-full" alt="" />
            <img src="/assets/maillogo.jpg" className=" my-auto icons hidden sm:block rounded-full" alt="" />
            </div>
        </div>
